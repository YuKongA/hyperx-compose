...
val MiuixIcons.RemoveBlocklist: ImageVector
    get() {
        if (_removeBlocklist != null) return _removeBlocklist!!
        _removeBlocklist = ImageVector.Builder("RemoveBlocklist", 26.0.dp, 26.0.dp, 26.0f, 26.0f).apply {
            path(
            ...
            path(
                ...
                moveTo(17.778f, 14.311f)
                curveTo(17.819f, 14.227f, 17.897f, 14.148f, 18.054f, 13.992f)
                curveTo(18.211f, 13.835f, 18.289f, 13.757f, 18.374f, 13.716f)
                curveTo(18.529f, 13.64f, 18.71f, 13.64f, 18.866f, 13.716f)
                curveTo(18.951f, 13.757f, 19.029f, 13.835f, 19.185f, 13.992f)
                lineTo(23.009f, 17.816f)
                lineTo(23.011f, 17.817f)
                curveTo(23.02f, 17.826f, 23.054f, 17.86f, 23.085f, 17.897f)
                curveTo(23.125f, 17.944f, 23.203f, 18.043f, 23.251f, 18.191f)
                curveTo(23.251f, 18.192f, 23.251f, 18.192f, 23.251f, 18.192f)
                curveTo(23.251f, 18.192f, 23.251f, 18.192f, 23.252f, 18.193f)
                curveTo(23.308f, 18.367f, 23.308f, 18.555f, 23.251f, 18.73f)
                curveTo(23.203f, 18.878f, 23.125f, 18.978f, 23.085f, 19.025f)
                curveTo(23.054f, 19.062f, 23.02f, 19.096f, 23.011f, 19.104f)
                lineTo(23.009f, 19.106f)
                lineTo(19.185f, 22.93f)
                curveTo(19.029f, 23.087f, 18.951f, 23.165f, 18.866f, 23.206f)
                curveTo(18.71f, 23.282f, 18.529f, 23.282f, 18.374f, 23.206f)
                curveTo(18.289f, 23.165f, 18.211f, 23.087f, 18.054f, 22.93f)
                curveTo(17.897f, 22.774f, 17.819f, 22.695f, 17.778f, 22.611f)
                curveTo(17.702f, 22.455f, 17.702f, 22.274f, 17.778f, 22.118f)
                curveTo(17.819f, 22.034f, 17.897f, 21.955f, 18.054f, 21.799f)
                lineTo(20.592f, 19.261f)
                horizontalLineTo(14.546f)
                curveTo(14.324f, 19.261f, 14.213f, 19.261f, 14.124f, 19.23f)
                curveTo(13.961f, 19.174f, 13.833f, 19.045f, 13.776f, 18.882f)
                curveTo(13.746f, 18.793f, 13.746f, 18.682f, 13.746f, 18.461f)
                curveTo(13.746f, 18.24f, 13.746f, 18.129f, 13.776f, 18.04f)
                curveTo(13.833f, 17.876f, 13.961f, 17.748f, 14.124f, 17.692f)
                curveTo(14.213f, 17.661f, 14.324f, 17.661f, 14.546f, 17.661f)
                horizontalLineTo(20.592f)
                lineTo(18.054f, 15.123f)
                curveTo(17.897f, 14.967f, 17.819f, 14.888f, 17.778f, 14.804f)
                curveTo(17.702f, 14.648f, 17.702f, 14.467f, 17.778f, 14.311f)
                close()
            }
        }.build()
        return _removeBlocklist!!
    }

private var _removeBlocklist: ImageVector? = null