...
val MiuixIcons.EditMessage: ImageVector
    get() {
        if (_editMessage != null) return _editMessage!!
        _editMessage = ImageVector.Builder("EditMessage", 26.0.dp, 26.0.dp, 26.0f, 26.0f).apply {
            path(
